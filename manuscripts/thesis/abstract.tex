...
The first seeks a dictionary for which each signal in a dataset is well-approximated by a linear superposition of a limited number of dictionary elements.
...
This work serves to justify, in principle, dictionary learning in general as a means of discovering latent sparse structure in real data. Though much work remains to be done deriving criteria for use in practice, the theoretical tools developed herein should be of use to this end.
