...
\section{Combinatorial designs for sparse supports}
...
\section{Deterministic uniqueness theorems}
...
\section{Probabilistic uniqueness theorems}
...
We conclude this chapter with some comments on the optimality of our results.  The linear scaling for $\varepsilon$ in \eqref{epsdel} is essentially optimal (e.g., see \cite{arias2013fundamental}), but a basic open problem remains: how many samples are necessary to determine the sparse coding model? 
