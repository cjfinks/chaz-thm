...
The goal of this work was to explain the emergence of characteristic representations from sparse coding models fit to natural data, despite the varied assumptions underlying the many algorithms in current use. To this end, we have taken an important step toward unifying the great number of publications on the topic by demonstrating very general, deterministic conditions under which identification of parameters in this parsimonious model is not only possible but also robust to the inevitable uncertainty permeating measurement and model choice.
