...
The only 1-uniform hypergraph satisfying the singleton intersection property is $[m]$; hence, we have $\mathbf{x}_i = c_i \mathbf{e}_i$ for $c_i \in \mathbb{R} \setminus \{\mathbf{0}\}$, $i \in [m]$. In this case we may take $C_1 = 1/ \min_{\ell \in [m]} |c_{\ell}|$. 
